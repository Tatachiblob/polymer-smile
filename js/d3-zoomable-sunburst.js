...
const m0 = {
  ...
  variables: [
    {
      //inputs: ["md"],
      //value: (function(md){return(md`# D3 Zoomable Sunburst
      ...
      value: (function(partition,data,d3,DOM,width,color,arc,format,radius)
{
  ...
  const svg = d3.select("#zoomable-sunburst").append("svg")//select(DOM.svg(width, width))
    //   .attr("width", "100%")//.style("width", "100%")
    // .attr("height", "1000px")//.style("height", "auto")
      .attr("preserveAspectRatio", "xMinYMin meet")
      .attr("viewBox", "-15 0 960 960")
