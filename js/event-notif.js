...
function getEventsThatEnded(){
    ...
    var url = getDbPath() + '/smile/event_calendar?filter={"end_period":{"$lte":' + curDate + '}}&sort=-end_period';
    $.ajax({
        async: false,
        type: "GET",
        url: url,
        ...
        success: function (response) {
            ...
            for(let a of response){
                ...
                if(isSeen) {
                    finishedEvents += '<li class="avatar" onclick="notif(\'' + tempId + '\', \'' + getDbPath() + '\', 0)"><a href="#"><img src="images/instagram_hashtag.png" alt=""><div class="text">Event finished ' + eventName + '</div><small>' + endDay + '</small></a></li>';
                    ...
                    finishedEvents += '<li class="avatar" onclick="notif(\'' + tempId + '\', \'' + getDbPath() + '\', 1)"><a href="#"><img src="images/instagram_hashtag.png" alt=""><div class="text">Event finished ' + eventName + '</div><small>' + endDay + '</small><span class="label label-info" style="margin-top: 10px;">NEW</span></a></li>';
