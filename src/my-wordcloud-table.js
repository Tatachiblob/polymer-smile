...
class MyWordcloudTable extends PolymerElement {
    static get template() {
        return html`
    ...
    __renderWordcloud(data){
        this.__getLabels(data);
        this.__getHashtagLabels(data);
    }
...
window.customElements.define('my-wordcloud-table', MyWordcloudTable);