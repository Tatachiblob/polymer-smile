    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for(let a of response){
                ...
                if(isSeen) {
                    finishedEvents += '<li class="avatar" onclick="notif(\'' + tempId + '\', 0)"><a><img src="images/instagram_hashtag.png" alt=""><div class="text">Event finished ' + eventName + '</div><small>' + endDay + '</small></a></li>';
                    ...
                    finishedEvents += '<li class="avatar" onclick="notif(\'' + tempId + '\', 1)"><a><img src="images/instagram_hashtag.png" alt=""><div class="text">Event finished ' + eventName + '</div><small>' + endDay + '</small><span class="label label-info" style="margin-top: 10px;">NEW</span></a></li>';
